...
class ConversationService:
    ...
    # app/services/conversation_service.py - 添加消息保存方法

    # app/services/conversation_service.py - 修改 save_message 方法

    def save_message(
        self, 
        conversation_id: int, 
        role: str,  # 这里是字符串，如 "user" 或 "assistant"
        content: str,
        tokens_used: Optional[int] = None,
        model_id: Optional[int] = None  # 添加 model_id 参数
    ) -> Dict[str, Any]:
        """保存消息到对话"""
        try:
            # 检查对话是否存在
            ...
            try:
                ...
                logger.warning(f"无效的角色: {role}, 使用默认值: user")
            ...
            return {
                ...
                "data": {
                    ...
                    "conversation_id": conversation_id,
                    "role": message.role.value,  # 使用 .value 获取字符串值
                    "content": content,
