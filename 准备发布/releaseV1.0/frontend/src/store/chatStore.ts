...
interface ChatState {
  ...
  originalContentMap: Record<string, string>; // messageId -> originalContent
  ...
  setOriginalContent: (messageId: string, originalContent: string) => void;
  ...
  persist(
    (set, get) => ({
      ...
      setContextSettings: (settings) => {
        set({ contextSettings: settings });
      },
      
      setOriginalContent: (messageId, originalContent) => {
        set((state) => ({
          originalContentMap: {
            ...state.originalContentMap,
            [messageId]: originalContent,
          },
        }));
      },
      
      clearOriginalContent: () => {
        set({ originalContentMap: {} });
      },
    }),
    {
      name: 'chat-storage',
